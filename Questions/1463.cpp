...
top down
state is defined as max cherries that can be collected
if robot1 is at row1 and col1 and second robot 2 is at row1 and col2
if already present use dp else calculate as per given instructions
*/
